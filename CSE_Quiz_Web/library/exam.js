...
reviewed_ans_for_exam=()=> {
    ...
    displayPreviousQuestionsAndChoicesForExamFor_data(data_00_QuestionsArray, data_00, 0, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_01_QuestionsArray, data_01, 5, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_02_QuestionsArray, data_02, 10, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_03_QuestionsArray, data_03, 15, false, false);

    displayPreviousQuestionsAndChoicesForExamFor_data(data_04_QuestionsArray, data_04, 20, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_05_QuestionsArray, data_05, 38, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_06_QuestionsArray, data_06, 54, false, false);

    displayPreviousQuestionsAndChoicesForExamFor_data(data_07_QuestionsArray, data_07, 70, true, false);
}
...
next_display_review_result=()=> {
    ...
    displayPreviousQuestionsAndChoicesForExamFor_data(data_08_QuestionsArray, data_08, 84, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_09_QuestionsArray, data_09, 96, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_10_QuestionsArray, data_10, 108, false, false);

    displayPreviousQuestionsAndChoicesForExamFor_data(data_11_QuestionsArray, data_11, 120, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_12_QuestionsArray, data_12, 134, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_13_QuestionsArray, data_13, 146, false, false);
    displayPreviousQuestionsAndChoicesForExamFor_data(data_14_QuestionsArray, data_14, 158, false, true);
}
 ...
 */
displayPreviousQuestionsAndChoicesForExamFor_data=(dataQuestionsIndex, dataQuestions, numberStart, displayFirstPagination, displaySecondPagination)=> {
    let prevQuestions = "";
    let questionIndex;
    let questionData;
