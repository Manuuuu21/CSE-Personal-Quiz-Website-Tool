...
let SELECT = {
	CREATOR_ANNOUNCEMENT: 	`<h1>IMPORTANT NOTE FROM THE CREATOR OF THIS WEBSITE</h1>
							<p>Dear Learners,</p>
							<p>I wanted to share an important note regarding the content on this website. I have developed quiz website to support education, specifically for individuals preparing for the Civil Service Exam. These data of questions were picked carefully from publicly available information on the internet, with the primary goal of making learning more accessible.</p>
